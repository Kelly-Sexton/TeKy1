function isAnagram(word1, word2) {
  ...
  if (word1Length !== word2Length) { return console.log(word2 + " is not an anagram of " + word1); }
  ...
  for (var i = 0; i < word2Length; i++) {
    ...
    if (!counts[index]) { return console.log(word2 + " is not an anagram of " + word1); }
    else { counts[index]--; }
  }

  return console.log(word2 + " is an anagram of " + word1);
}
